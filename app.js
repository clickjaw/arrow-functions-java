...
Student.courseName = (name) => `This student is in Code 301: ${name}`;

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(Student.courseName('React'));
...
// this is every property inside the object Student for Joe

// 2. What is "this" when joe.scopeArrow() is invoked?
//I believe it refers back to every property of React
// 3. Explain why "this" is different when an arrow function is used.
// "this" is not bound to anything in an arrow function